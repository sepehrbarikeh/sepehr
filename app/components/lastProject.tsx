...
const LastProject = () => {
    ...
    useEffect(() => {
        ...
        const ctx = gsap.context(() => {
            // اعمال دقیق انیمیشن ورود نرم و موازی (Stagger) با اسکرول
            gsap.fromTo(".projects-anim",
                { opacity: 0, y: 30 },
                {
                    opacity: 1,
                    y: 0,
    ...
    return (
        ...
        >
            {/* هدر سکشن مینی پروژه‌ها هماهنگ با استایل آخرین مقالات */}
            <div dir="rtl" className="flex flex-col items-center text-center mb-10 space-y-2">
                <span className="projects-anim text-xs font-bold tracking-widest text-purple-500 uppercase font-mono">
                    MINI PROJECTS
                </span>
                <h2
                    className="projects-anim text-2xl md:text-3xl font-black text-white leading-tight"
                    style={{ fontFamily: 'vazir-bold' }}
                >
                    مینی پروژه‌ها
                </h2>
                <p
                    className="projects-anim text-zinc-400 text-sm md:text-base max-w-xl leading-relaxed"
            ...
            {/* اسلایدر پروژه‌ها با انیمیشن ورود یکپارچه */}
            <div className="projects-anim">
                <ModernSlider>
                    ...
                    {/* کارت مدرن و نئونی "مشاهده همه پروژه‌ها" */}
                    <Link
                        href="/project"
                    ...
                    >
                        ...
                        <div className="p-4 flex flex-col h-[290px] justify-between relative z-10" dir="rtl">
                            <div>
                                {/* باکس آیکون - مجهز به کامپوننت هوشمند FileTerminal */}
                                <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-white/[0.02] border border-white/[0.05] text-purple-400 group-hover:text-purple-300 group-hover:bg-purple-500/10 transition-all duration-300">
                                    <FileTerminal className="h-6 w-6 transition-transform duration-300 group-hover:scale-110" />
                                </div>
